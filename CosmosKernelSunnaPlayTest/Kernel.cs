...
namespace CosmosKernelSunnaPlayTest
{
    public class Kernel : Sys.Kernel
    {
        ...
        public void DrawACSIIString(Canvas canvas, Color color, string s, int x, int y, int scale)
        {
            ...
            for (int l = 0; l < lines.Length; l++)
            {
                for (int c = 0; c < lines[l].Length; c++)
                {
                    ...
                    for (int i = 0; i < 16 * scale; i++) // Aumentamos el alto según el factor de escala
                    {
                        for (int j = 0; j < 8 * scale; j++) // Aumentamos el ancho según el factor de escala
                        {
        ...
        protected override void Run()
        {
            try
            {
                DrawACSIIString(canvas, Color.LimeGreen, "S'.O.S.", 750, 150, 8);
                DrawACSIIString(canvas, Color.LimeGreen, "Choose an option [1..3]", 65, 400, 3);
                DrawACSIIString(canvas, Color.LimeGreen, "1. Open Menu", 65, 500, 3);
                DrawACSIIString(canvas, Color.LimeGreen, "2. Shutdown", 65, 600, 3);
                DrawACSIIString(canvas, Color.LimeGreen, "3. Reboot", 65, 700, 3);
                canvas.Display();
        ...
        {
            canvas.Clear();
            DrawACSIIString(canvas, Color.LimeGreen, "Help", 25, 215, 2);
            DrawACSIIString(canvas, Color.LimeGreen, "About", 25, 245, 2);
            DrawACSIIString(canvas, Color.LimeGreen, "File Management", 25, 275, 2);
            ...
            {
                canvas.Clear();
                DrawACSIIString(canvas, Color.LimeGreen, "List of commands", 65, 400, 3);
            ...
            {
                canvas.Clear();
                DrawACSIIString(canvas, Color.LimeGreen, "Get list of files and directories", 65, 400, 1);
                DrawACSIIString(canvas, Color.LimeGreen, "Read all files from directory", 65, 450, 1);
                DrawACSIIString(canvas, Color.LimeGreen, "Create new directory", 65, 500, 1);
                DrawACSIIString(canvas, Color.LimeGreen, "Create new file", 65, 550, 1);
                DrawACSIIString(canvas, Color.LimeGreen, "Delete a file or directory", 65, 600, 1);
            ...
            void Consultaespaidisp()
            {
                ...
                DrawACSIIString(canvas, Color.LimeGreen, "Available Free Space: " + available_space, 65, 500, 3);
                canvas.Display();
            }
